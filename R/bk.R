...
# BK CON MUERTES TOTALES ECUADOR
...
# INI 
# MUERTES SEMANAS EPIDEMIOLOGICAS 2021 PICHINCHA
picm21 <- muertes21 %>% 
  filter(provincia == "Pichincha", 
         canton %in% c("Cayambe", 
                       "Mejía", 
                       ...
                       "San Miguel de Los Bancos")) %>%
  group_by(canton) %>%
  select(provincia, canton, total, acumuladas, created_at)
#  filter(created_at >= as.Date("2021-01-03") & created_at <= as.Date("2021-01-09"))
picm21s1 <- filter(picm21, created_at >= as.Date("2021-01-01") & 
                     created_at <= as.Date("2021-01-09"))
picm21s2 <- filter(picm21, created_at >= as.Date("2021-01-10") & 
                     created_at <= as.Date("2021-01-16"))
picm21s3 <- filter(picm21, created_at >= as.Date("2021-01-17") & 
                     created_at <= as.Date("2021-01-23"))
picm21s4 <- filter(picm21, created_at >= as.Date("2021-01-24") & 
                     created_at <= as.Date("2021-01-30"))
picm21s5 <- filter(picm21, created_at >= as.Date("2021-01-31") & 
                     created_at <= as.Date("2021-02-06"))
picm21s6 <- filter(picm21, created_at >= as.Date("2021-02-07") & 
                     created_at <= as.Date("2021-02-13"))
picm21s7 <- filter(picm21, created_at >= as.Date("2021-02-14") & 
                     created_at <= as.Date("2021-02-20"))
picm21s8 <- filter(picm21, created_at >= as.Date("2021-02-21") & 
                     created_at <= as.Date("2021-02-27"))
picm21s9 <- filter(picm21, created_at >= as.Date("2021-02-28") & 
                     created_at <= as.Date("2021-03-06"))
picm21s10 <- filter(picm21, created_at >= as.Date("2021-03-07") & 
                      created_at <= as.Date("2021-03-13"))
picm21s11 <- filter(picm21, created_at >= as.Date("2021-03-14") & 
                      created_at <= as.Date("2021-03-20"))
picm21s12 <- filter(picm21, created_at >= as.Date("2021-03-21") & 
                      created_at <= as.Date("2021-03-27"))
picm21s13 <- filter(picm21, created_at >= as.Date("2021-03-28") & 
                      created_at <= as.Date("2021-04-03"))
picm21s14 <- filter(picm21, created_at >= as.Date("2021-04-04") & 
                      created_at <= as.Date("2021-04-10"))
picm21s15 <- filter(picm21, created_at >= as.Date("2021-04-11") & 
                      created_at <= as.Date("2021-04-17"))
picm21s16 <- filter(picm21, created_at >= as.Date("2021-04-18") & 
                      created_at <= as.Date("2021-04-24"))
picm21s17 <- filter(picm21, created_at >= as.Date("2021-04-25") & 
                      created_at <= as.Date("2021-05-01"))
picm21s18 <- filter(picm21, created_at >= as.Date("2021-05-02") & 
                      created_at <= as.Date("2021-05-08"))
picm21s19 <- filter(picm21, created_at >= as.Date("2021-05-09") & 
                      created_at <= as.Date("2021-05-15"))
picm21s20 <- filter(picm21, created_at >= as.Date("2021-05-16") & 
                      created_at <= as.Date("2021-05-22"))
picm21s21 <- filter(picm21, created_at >= as.Date("2021-05-23") & 
                      created_at <= as.Date("2021-05-29"))
picm21s22 <- filter(picm21, created_at >= as.Date("2021-05-30") & 
                      created_at <= as.Date("2021-06-05"))
picm21s23 <- filter(picm21, created_at >= as.Date("2021-06-06") & 
                      created_at <= as.Date("2021-06-12"))
picm21s24 <- filter(picm21, created_at >= as.Date("2021-06-13") & 
                      created_at <= as.Date("2021-06-19"))
picm21s25 <- filter(picm21, created_at >= as.Date("2021-06-20") & 
                      created_at <= as.Date("2021-06-26"))
picm21s26 <- filter(picm21, created_at >= as.Date("2021-06-27") & 
                      created_at <= as.Date("2021-07-03"))
picm21s27 <- filter(picm21, created_at >= as.Date("2021-07-04") & 
                      created_at <= as.Date("2021-07-10"))
picm21s28 <- filter(picm21, created_at >= as.Date("2021-07-11") & 
                      created_at <= as.Date("2021-07-17"))
picm21s29 <- filter(picm21, created_at >= as.Date("2021-07-18") & 
                      created_at <= as.Date("2021-07-24"))
picm21s30 <- filter(picm21, created_at >= as.Date("2021-07-25") & 
                      created_at <= as.Date("2021-07-31"))
picm21s31 <- filter(picm21, created_at >= as.Date("2021-08-01") & 
                      created_at <= as.Date("2021-08-07"))
picm21s32 <- filter(picm21, created_at >= as.Date("2021-08-08") & 
                      created_at <= as.Date("2021-08-14"))
picm21s33 <- filter(picm21, created_at >= as.Date("2021-08-15") & 
                      created_at <= as.Date("2021-08-21"))
picm21s34 <- filter(picm21, created_at >= as.Date("2021-08-22") & 
                      created_at <= as.Date("2021-08-28"))
picm21s35 <- filter(picm21, created_at >= as.Date("2021-08-29") & 
                      created_at <= as.Date("2021-09-04"))
picm21s36 <- filter(picm21, created_at >= as.Date("2021-09-05") & 
                      created_at <= as.Date("2021-09-11"))
picm21s37 <- filter(picm21, created_at >= as.Date("2021-09-12") & 
                      created_at <= as.Date("2021-09-18"))
picm21s38 <- filter(picm21, created_at >= as.Date("2021-09-19") & 
                      created_at <= as.Date("2021-09-25"))
picm21s39 <- filter(picm21, created_at >= as.Date("2021-09-26") & 
                      created_at <= as.Date("2021-10-02"))
picm21s40 <- filter(picm21, created_at >= as.Date("2021-10-03") & 
                      created_at <= as.Date("2021-10-09"))
picm21s41 <- filter(picm21, created_at >= as.Date("2021-10-10") & 
                      created_at <= as.Date("2021-10-16"))
picm21s42 <- filter(picm21, created_at >= as.Date("2021-10-17") & 
                      created_at <= as.Date("2021-10-23"))
picm21s43 <- filter(picm21, created_at >= as.Date("2021-10-24") & 
                      created_at <= as.Date("2021-10-30"))
picm21s44 <- filter(picm21, created_at >= as.Date("2021-10-31") & 
                      created_at <= as.Date("2021-11-06"))
picm21s45 <- filter(picm21, created_at >= as.Date("2021-11-07") & 
                      created_at <= as.Date("2021-11-13"))
picm21s46 <- filter(picm21, created_at >= as.Date("2021-11-14") & 
                      created_at <= as.Date("2021-11-20"))
picm21s47 <- filter(picm21, created_at >= as.Date("2021-11-21") & 
                      created_at <= as.Date("2021-11-27"))
picm21s48 <- filter(picm21, created_at >= as.Date("2021-11-28") & 
                      created_at <= as.Date("2021-12-04"))
picm21s49 <- filter(picm21, created_at >= as.Date("2021-12-05") & 
                      created_at <= as.Date("2021-12-11"))
picm21s50 <- filter(picm21, created_at >= as.Date("2021-12-12") & 
                      created_at <= as.Date("2021-12-18"))
picm21s51 <- filter(picm21, created_at >= as.Date("2021-12-19") & 
                      created_at <= as.Date("2021-12-25"))
picm21s52 <- filter(picm21, created_at >= as.Date("2021-12-26") & 
                      created_at <= as.Date("2021-12-31"))


# *FIN* SEMANAS EPIDEMIOLOGICAS 2022 PICHINCHA
pich22 <- cantones22 %>% 
  filter(provincia == "Pichincha", 
         canton %in% c("Cayambe", 
                       "Mejía", 
...
df <- data.frame(sem.epi = c('Feb20-10', 'Feb20-17',
                             'Feb20-24', 'Mar20-2', 'Mar20-9', 'Mar20-16', 'Mar20-23',
                 ...
                 con.cov = c(sum(pic20s7$nuevas),
                             sum(pic20s8$nuevas), sum(pic20s9$nuevas),
                             sum(pic20s10$nuevas), sum(pic20s11$nuevas),
                 ...
                 con.cap = c(sum(filter(pic20s7, canton == "Quito")$nuevas),
                             sum(filter(pic20s8, canton == "Quito")$nuevas),
                             sum(filter(pic20s9, canton == "Quito")$nuevas),
                             sum(filter(pic20s10, canton == "Quito")$nuevas),
                             sum(filter(pic20s11, canton == "Quito")$nuevas),
